...
.. note::
    ...
    allows the program to run with the Intel Fortran libraries statically compiled 
...
.. note::
    ...
    steps have been followed correctly. It is also a way to ensure that the configuration 
    paths provided in the configuration are valid and point to the right location.)
