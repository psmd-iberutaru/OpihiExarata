...
staff. (For general use purposes, see the User Manual (:ref:`home-user-manual`).)
It details the overall architectural design and thought process of the 
OpihiExarata software in much greater detail to assist in development. 
It can be accessed via the sidebar or by clicking :doc:`here <./user/index>`.
...
Unlike the Technical Manual (:ref:`home-technical-manual`), this does not detail
