...
class Ui_AutomaticWindow:
    def setupUi(self, AutomaticWindow):
        ...
        self.vertical_layout_automatic.setObjectName(
            "vertical_layout_automatic",
        )
        self.vertical_layout_automatic.setContentsMargins(0, 0, 0, 0)
        self.horizontal_layout_directory = QHBoxLayout()
        self.horizontal_layout_directory.setObjectName(
            "horizontal_layout_directory",
        )
        self.label_static_fits_directory = QLabel(self.verticalLayoutWidget)
        self.label_static_fits_directory.setObjectName(
            "label_static_fits_directory",
        )
        self.label_static_fits_directory.setFont(font)

        self.horizontal_layout_directory.addWidget(
            self.label_static_fits_directory,
        )

        self.label_dynamic_fits_directory = QLabel(self.verticalLayoutWidget)
        self.label_dynamic_fits_directory.setObjectName(
            "label_dynamic_fits_directory",
        )
        self.label_dynamic_fits_directory.setFont(font)

        self.horizontal_layout_directory.addWidget(
            self.label_dynamic_fits_directory,
        )
        ...
        self.push_button_change_directory = QPushButton(
            self.verticalLayoutWidget,
        )
        self.push_button_change_directory.setObjectName(
            "push_button_change_directory",
        )
        self.push_button_change_directory.setFont(font)

        self.horizontal_layout_directory.addWidget(
            self.push_button_change_directory,
        )

        self.vertical_layout_automatic.addLayout(
            self.horizontal_layout_directory,
        )
        ...
        self.horizontal_layout_engines.setObjectName(
            "horizontal_layout_engines",
        )
        ...
        self.horizontal_layout_engines.addWidget(
        ...
        self.grid_layout_fits_filenames.setObjectName(
            "grid_layout_fits_filenames",
        )
        ...
        self.grid_layout_fits_filenames.addWidget(
            self.label_static_results_filename,
            2,
            0,
            1,
            1,
        ...
        self.grid_layout_fits_filenames.addWidget(
            self.label_dynamic_results_filename,
            2,
            1,
            1,
            1,
        ...
        self.grid_layout_fits_filenames.addWidget(
            self.label_static_working_filename,
            1,
            0,
            1,
            1,
        ...
        self.grid_layout_fits_filenames.addWidget(
            self.label_dynamic_working_filename,
            1,
            1,
            1,
            1,
        ...
        self.label_static_fetch_filename.setObjectName(
            "label_static_fetch_filename",
        )

        self.grid_layout_fits_filenames.addWidget(
            self.label_static_fetch_filename,
            0,
            0,
            1,
            1,
        ...
        self.label_dynamic_fetch_filename.setObjectName(
            "label_dynamic_fetch_filename",
        )

        self.grid_layout_fits_filenames.addWidget(
            self.label_dynamic_fetch_filename,
            0,
            1,
            1,
            1,
        ...
        self.vertical_layout_automatic.addLayout(
            self.grid_layout_fits_filenames,
        )
        ...
        self.horizontal_layout_astrometry_results.addWidget(
            self.label_static_ra_dec,
        )
        ...
        self.horizontal_layout_start_stop.setObjectName(
            "horizontal_layout_start_stop",
        )
        ...
        self.label_dynamic_operational_status = QLabel(
            self.verticalLayoutWidget,
        )
        ...
        self.vertical_layout_automatic.addLayout(
            self.horizontal_layout_start_stop,
        )
