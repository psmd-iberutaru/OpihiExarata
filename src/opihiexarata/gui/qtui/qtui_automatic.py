...
class Ui_AutomaticWindow(object):
    def setupUi(self, AutomaticWindow):
        ...
        self.grid_layout_fits_filenames.addWidget(
            self.label_dynamic_working_filename, 0, 2, 1, 1
        )
        ...
        self.grid_layout_fits_filenames.addWidget(
            self.label_dynamic_results_filename, 1, 2, 1, 1
        )
        ...
        self.horizontal_layout_date_time.setObjectName("horizontal_layout_date_time")
        self.label_static_date_time = QLabel(self.verticalLayoutWidget)
        self.label_static_date_time.setObjectName("label_static_date_time")
    ...
    def retranslateUi(self, AutomaticWindow):
        AutomaticWindow.setWindowTitle(
            QCoreApplication.translate("AutomaticWindow", "MainWindow", None)
        )
        ...
        self.label_static_date_time.setText(
            QCoreApplication.translate("AutomaticWindow", "Observed At (UTC)", None)
        )
        ...
        self.label_static_ra_dec.setText(
            QCoreApplication.translate("AutomaticWindow", "Center Coordinates", None)
        )
        ...
        self.label_static_operational_status.setText(
            QCoreApplication.translate("AutomaticWindow", "Status", None)
        )
