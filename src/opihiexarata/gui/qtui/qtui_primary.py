...
class Ui_PrimaryWindow(object):
    def setupUi(self, PrimaryWindow):
        ...
        self.grid_layout_propagate_results = QtWidgets.QGridLayout()
        self.grid_layout_propagate_results.setObjectName("grid_layout_propagate_results")
        self.label_dynamic_propagate_dec = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.label_dynamic_propagate_dec.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_dynamic_propagate_dec.setObjectName("label_dynamic_propagate_dec")
        self.grid_layout_propagate_results.addWidget(self.label_dynamic_propagate_dec, 0, 4, 1, 1)
        self.label_dynamic_propagate_ra = QtWidgets.QLabel(self.verticalLayoutWidget_4)
        self.label_dynamic_propagate_ra.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_dynamic_propagate_ra.setObjectName("label_dynamic_propagate_ra")
        self.grid_layout_propagate_results.addWidget(self.label_dynamic_propagate_ra, 0, 3, 1, 1)
        ...
        self.grid_layout_propagate_results.addWidget(self.push_button_propagate_custom_solve, 0, 2, 1, 1)
        ...
        self.combo_box_propagate_timezone.addItem("")
        self.grid_layout_propagate_results.addWidget(self.combo_box_propagate_timezone, 0, 1, 1, 1)
        ...
        self.grid_layout_propagate_results.addWidget(self.date_time_edit_propagate_date_time, 0, 0, 1, 1)
    ...
    def retranslateUi(self, PrimaryWindow):
        ...
        self.label_dynamic_propagate_dec.setText(_translate("PrimaryWindow", "+DD:MM:SS.SS"))
        self.label_dynamic_propagate_ra.setText(_translate("PrimaryWindow", "HH:MM:SS.SS"))
