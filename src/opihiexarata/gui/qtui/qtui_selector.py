...
class Ui_SelectorWindow(object):
    def setupUi(self, SelectorWindow):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 604, 838))
        font = QtGui.QFont()
        ...
        self.dummy_opihi_image = QtWidgets.QGraphicsView(self.verticalLayoutWidget)
        self.dummy_opihi_image.setMinimumSize(QtCore.QSize(600, 600))
        self.dummy_opihi_image.setMaximumSize(QtCore.QSize(600, 600))
        self.dummy_opihi_image.setObjectName("dummy_opihi_image")
        self.vertical_layout_image.addWidget(self.dummy_opihi_image)
        self.dummy_opihi_navbar = QtWidgets.QLabel(self.verticalLayoutWidget)
        ...
        self.check_box_autoscale_1_99 = QtWidgets.QCheckBox(self.verticalLayoutWidget)
    ...
    def retranslateUi(self, SelectorWindow):
        ...
        self.push_button_submit_target.setText(_translate("SelectorWindow", "Submit"))
