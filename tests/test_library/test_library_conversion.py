...
def test_decimal_day_to_unix_time() -> None:
    ...
    origin_unix_time = 0
    test_origin_unix_time = opihiexarata.library.conversion.decimal_day_to_unix_time(
    ...
    test_tower_unix_time = opihiexarata.library.conversion.decimal_day_to_unix_time(
...
def test_full_date_to_unix_time() -> None:
    ...
    # The defining definition of UNIX time.
    origin_unix_time = 0
    test_origin_unix_time = opihiexarata.library.conversion.full_date_to_unix_time(
    ...
    test_tower_unix_time = opihiexarata.library.conversion.full_date_to_unix_time(
